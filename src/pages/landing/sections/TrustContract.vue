<template>
  <section class="wrapper-block-four py-5">
    <img class="graph" src="~@/assets/img/bg4.png" alt="">
    <img class="mockup" src="~@/assets/img/Mockup.png" alt="">
